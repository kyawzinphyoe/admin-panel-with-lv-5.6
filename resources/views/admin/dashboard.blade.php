            ...
            <div class="chat-users panel-right2">
              ...
              <div class="panel-content nopadding">
                <ul class="contact-list">
                  <li id="user-Alex" class="online"><a href=""><img alt="" src="{{ asset('images/backend/demo/av1.jpg" /> <sp') }}an>Alex</span></a></li>
                  <li id="user-Linda"><a href=""><img alt="" src="{{ asset('images/backend/demo/av2.jpg" /> <sp') }}an>Linda</span></a></li>
                  <li id="user-John" class="online new"><a href=""><img alt="" src="{{ asset('images/backend/demo/av3.jpg" /> <sp') }}an>John</span></a><span class="msg-count badge badge-info">3</span></li>
                  <li id="user-Mark" class="online"><a href=""><img alt="" src="{{ asset('images/backend/demo/av4.jpg" /> <sp') }}an>Mark</span></a></li>
                  <li id="user-Maxi" class="online"><a href=""><img alt="" src="{{ asset('images/backend/demo/av5.jpg" /> <sp') }}an>Maxi</span></a></li>
                </ul>
              </div>
            </div>
